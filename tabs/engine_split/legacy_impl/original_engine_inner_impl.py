"""Compatibility loader for the refactored `tabs/engine_split/legacy_impl/original_engine_inner_impl.py` module.

The original large file was split into `original_engine_inner_impl_parts/part_*.py` chunks so no
...
_PARTS_PACKAGE = (__package__ + '.original_engine_inner_impl_parts') if __package__ else 'original_engine_inner_impl_parts'
_PART_COUNT = 3
