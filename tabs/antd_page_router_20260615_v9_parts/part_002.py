...
SOURCE_LINES = [
    ...
    '        st.markdown("### 🔌 Finnhub + Twelve Data + MT5 Market Connector — Always Visible")\n',
    '        st.caption("Choose the global instrument, Finnhub/Twelve Data/MT5/fallback source, timeframe and candle count. A symbol change refreshes only that instrument and marks the prior canonical generation stale until the next explicit run.")\n',
    '        st.number_input(\n',
    ...
    '            source_options = ["finnhub", "twelve", "mt5", "doo_bridge", "fallback", "safe_demo"]\n',
    '            current_source = str(st.session_state.get("connector_mode") or "finnhub")\n',
    '            if current_source not in source_options:\n',
    '                current_source = "finnhub"\n',
