...
_source = "".join(
    ...
    for line in import_module(f"tabs.antd_page_router_20260615_v9_parts.{part_name}").SOURCE_LINES
)
_ORIGINAL_FILE = str(Path(__file__).resolve().parent.parent / 'antd_page_router_20260615.py')
NAMESPACE = {
    "__name__": 'tabs.antd_page_router_20260615',
    "__package__": 'tabs',
