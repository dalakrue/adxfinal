"""Compatibility loader for the refactored `tabs/train/legacy_impl/train_data_legacy_impl.py` module.

The original large file was split into `train_data_legacy_impl_parts/part_*.py` chunks so no
...
_PARTS_PACKAGE = (__package__ + '.train_data_legacy_impl_parts') if __package__ else 'train_data_legacy_impl_parts'
_PART_COUNT = 2
