"""Compatibility loader for the refactored `tabs/legacy_impl/upgraded_doo_prime_home_impl.py` module.

The original large file was split into `upgraded_doo_prime_home_impl_parts/part_*.py` chunks so no
...
_PARTS_PACKAGE = (__package__ + '.upgraded_doo_prime_home_impl_parts') if __package__ else 'upgraded_doo_prime_home_impl_parts'
_PART_COUNT = 4
