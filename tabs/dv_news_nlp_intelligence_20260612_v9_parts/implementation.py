...
_source = "".join(
    ...
    for line in import_module(f"tabs.dv_news_nlp_intelligence_20260612_v9_parts.{part_name}").SOURCE_LINES
)
_ORIGINAL_FILE = str(Path(__file__).resolve().parent.parent / 'dv_news_nlp_intelligence_20260612.py')
NAMESPACE = {
    "__name__": 'tabs.dv_news_nlp_intelligence_20260612',
    "__package__": 'tabs',
