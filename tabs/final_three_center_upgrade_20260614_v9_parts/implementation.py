...
_source = "".join(
    ...
    for line in import_module(f"tabs.final_three_center_upgrade_20260614_v9_parts.{part_name}").SOURCE_LINES
)
_ORIGINAL_FILE = str(Path(__file__).resolve().parent.parent / 'final_three_center_upgrade_20260614.py')
NAMESPACE = {
    "__name__": 'tabs.final_three_center_upgrade_20260614',
    "__package__": 'tabs',
