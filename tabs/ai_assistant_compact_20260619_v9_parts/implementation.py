...
_source = "".join(
    ...
    for line in import_module(f"tabs.ai_assistant_compact_20260619_v9_parts.{part_name}").SOURCE_LINES
)
_ORIGINAL_FILE = str(Path(__file__).resolve().parent.parent / 'ai_assistant_compact_20260619.py')
NAMESPACE = {
    "__name__": 'tabs.ai_assistant_compact_20260619',
    "__package__": 'tabs',
