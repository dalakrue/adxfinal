...
_source = "".join(
    ...
    for line in import_module(f"core.lunch_broker_sentiment_ai_history_20260622_v9_parts.{part_name}").SOURCE_LINES
)
_ORIGINAL_FILE = str(Path(__file__).resolve().parent.parent / 'lunch_broker_sentiment_ai_history_20260622.py')
NAMESPACE = {
    "__name__": 'core.lunch_broker_sentiment_ai_history_20260622',
    "__package__": 'core',
