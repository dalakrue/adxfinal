...
_source = "".join(
    ...
    for line in import_module(f"core.shared_broker_time_20260622_v9_parts.{part_name}").SOURCE_LINES
)
_ORIGINAL_FILE = str(Path(__file__).resolve().parent.parent / 'shared_broker_time_20260622.py')
NAMESPACE = {
    "__name__": 'core.shared_broker_time_20260622',
    "__package__": 'core',
