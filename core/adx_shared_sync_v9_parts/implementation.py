...
_source = "".join(
    ...
    for line in import_module(f"core.adx_shared_sync_v9_parts.{part_name}").SOURCE_LINES
)
_ORIGINAL_FILE = str(Path(__file__).resolve().parent.parent / 'adx_shared_sync_20260615.py')
NAMESPACE = {
    "__name__": 'core.adx_shared_sync_20260615',
    "__package__": 'core',
