...
_source = "".join(
    ...
    for line in import_module(f"core.multiscale_probabilistic_upgrade_20260618_v9_parts.{part_name}").SOURCE_LINES
)
_ORIGINAL_FILE = str(Path(__file__).resolve().parent.parent / 'multiscale_probabilistic_upgrade_20260618.py')
NAMESPACE = {
    "__name__": 'core.multiscale_probabilistic_upgrade_20260618',
    "__package__": 'core',
