...
_source = "".join(
    ...
    for line in import_module(f"core.causal_quant_support_20260618_v9_parts.{part_name}").SOURCE_LINES
)
_ORIGINAL_FILE = str(Path(__file__).resolve().parent.parent / 'causal_quant_support_20260618.py')
NAMESPACE = {
    "__name__": 'core.causal_quant_support_20260618',
    "__package__": 'core',
