...
_source = "".join(
    ...
    for line in import_module(f"core.finnhub_connector_v9_parts.{part_name}").SOURCE_LINES
)
_ORIGINAL_FILE = str(Path(__file__).resolve().parent.parent / 'finnhub_connector.py')
NAMESPACE = {
    "__name__": 'core.finnhub_connector',
    "__package__": 'core',
