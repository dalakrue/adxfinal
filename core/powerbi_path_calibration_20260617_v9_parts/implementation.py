...
_source = "".join(
    ...
    for line in import_module(f"core.powerbi_path_calibration_20260617_v9_parts.{part_name}").SOURCE_LINES
)
_ORIGINAL_FILE = str(Path(__file__).resolve().parent.parent / 'powerbi_path_calibration_20260617.py')
NAMESPACE = {
    "__name__": 'core.powerbi_path_calibration_20260617',
    "__package__": 'core',
