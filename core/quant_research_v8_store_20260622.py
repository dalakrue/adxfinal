...
def _canonical_identity(canonical: Mapping[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "generation_id": canonical.get("calculation_generation") or canonical.get("generation_id") or 0,
    ...
    try:
        ...
        for row in settled_norm.tail(1000).to_dict("records"):
            ...
            settled_record={
                ...
                "generation_id":int(_finite(row.get("generation_id")) or identity["generation_id"] or 0), "horizon_hours":int(row.get("horizon_hours")),
