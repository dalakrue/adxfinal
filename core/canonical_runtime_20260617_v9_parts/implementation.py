...
_source = "".join(
    ...
    for line in import_module(f"core.canonical_runtime_20260617_v9_parts.{part_name}").SOURCE_LINES
)
_ORIGINAL_FILE = str(Path(__file__).resolve().parent.parent / 'canonical_runtime_20260617.py')
NAMESPACE = {
    "__name__": 'core.canonical_runtime_20260617',
    "__package__": 'core',
