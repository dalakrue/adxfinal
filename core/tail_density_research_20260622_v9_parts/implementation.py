...
_source = "".join(
    ...
    for line in import_module(f"core.tail_density_research_20260622_v9_parts.{part_name}").SOURCE_LINES
)
_ORIGINAL_FILE = str(Path(__file__).resolve().parent.parent / 'tail_density_research_20260622.py')
NAMESPACE = {
    "__name__": 'core.tail_density_research_20260622',
    "__package__": 'core',
