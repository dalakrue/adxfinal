...
_source = "".join(
    ...
    for line in import_module(f"core.regime_sync_20260617_v9_parts.{part_name}").SOURCE_LINES
)
_ORIGINAL_FILE = str(Path(__file__).resolve().parent.parent / 'regime_sync_20260617.py')
NAMESPACE = {
    "__name__": 'core.regime_sync_20260617',
    "__package__": 'core',
