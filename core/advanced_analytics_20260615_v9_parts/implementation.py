...
_source = "".join(
    ...
    for line in import_module(f"core.advanced_analytics_20260615_v9_parts.{part_name}").SOURCE_LINES
)
_ORIGINAL_FILE = str(Path(__file__).resolve().parent.parent / 'advanced_analytics_20260615.py')
NAMESPACE = {
    "__name__": 'core.advanced_analytics_20260615',
    "__package__": 'core',
