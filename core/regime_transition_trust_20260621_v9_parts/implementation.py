...
_source = "".join(
    ...
    for line in import_module(f"core.regime_transition_trust_20260621_v9_parts.{part_name}").SOURCE_LINES
)
_ORIGINAL_FILE = str(Path(__file__).resolve().parent.parent / 'regime_transition_trust_20260621.py')
NAMESPACE = {
    "__name__": 'core.regime_transition_trust_20260621',
    "__package__": 'core',
