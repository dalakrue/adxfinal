"""Compatibility loader for the refactored `core/legacy_impl/system_contract_impl.py` module.

The original large file was split into `system_contract_impl_parts/part_*.py` chunks so no
...
_PARTS_PACKAGE = (__package__ + '.system_contract_impl_parts') if __package__ else 'system_contract_impl_parts'
_PART_COUNT = 2
