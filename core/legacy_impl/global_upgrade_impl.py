"""Compatibility loader for the refactored `core/legacy_impl/global_upgrade_impl.py` module.

The original large file was split into `global_upgrade_impl_parts/part_*.py` chunks so no
...
_PARTS_PACKAGE = (__package__ + '.global_upgrade_impl_parts') if __package__ else 'global_upgrade_impl_parts'
_PART_COUNT = 2
