...
PAGES: List[str] = ["Settings", "Home", "Lunch", "Dinner", "AI Assistant", "Morning", "Research", "Other"]
...
def _normalize_page(page: str | None) -> str:
    ...
    aliases = {"Data Visualization": "Lunch", "Metric": "Lunch", "Doo Prime": "Morning", "Regime": "Dinner", "Field 567": "Dinner", "Field 4 to 9": "Dinner", "Field 456": "Dinner", "Field 789": "Dinner"}
...
def _menu_items():
    return [
        ...
        sac.MenuItem("Dinner", icon="appstore", children=[sac.MenuItem(x) for x in DINNER_CHILDREN]),
